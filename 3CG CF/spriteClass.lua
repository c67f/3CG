...
function SpriteClass:getSprite() --
  --print(#self.sprites)
  return self.sprites[1] --currently sprites don't need to be a table, but it's there for potentially future animated sprites. right now the sprite for anything will always be the first one in the table since there will only be one in the table
end
